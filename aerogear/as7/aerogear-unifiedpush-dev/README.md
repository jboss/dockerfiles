...
`docker run -it -p 8443:8443 jboss/aerogear-unifiedpush-as7-dev`

## Building the image (alternative)

Clone the repo and build yourself:

`docker build -t jboss/aerogear-unifiedpush-as7-dev .`
...
`docker run --rm -it --entrypoint=/bin/bash jboss/aerogear-unifiedpush-as7-dev && cd ..`
